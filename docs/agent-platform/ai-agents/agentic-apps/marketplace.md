...
2. Browse by category or search for an app. Select an app to view its capabilities, associated tools, model compatibility, language support, and installation instructions of the tools and agents.
