...
2. Select one of the three tabs on the Models page, from amongst fine-tuned models, open-source models, and external models. Select any tab to explore the available models.
