...
By default, the Microsoft Teams app appears with the name **(In)Business Productivity**, the standard logo, and the default description. Administrators can customize the application before publishing to Microsoft Teams:
...
Deploy the app to Microsoft Teams for user access.
...
You can decide how to distribute the app in Microsoft Teams:

* **Add App for All Users** (Recommended)

    * Automatically adds the app for all employees in the organization.
