...
4. Configure Autonomous Agent: The configuration step establishes the technical foundation of your agent through API integration.  
     ...
     * **Content Type**: Enter a specific label that tells the API what kind of data you are sending.
     ...
     Curl Import: For existing APIs, use the CURL Import functionality to automatically populate API configuration, see App Deployment documentation in the (In)Agent Platform to learn more about retrieving cURL of AI Agent from Agent Platform.
